...
#ifndef EXAMPLES_PDEVS_GRAPH_MANAGER_HPP
#define EXAMPLES_PDEVS_GRAPH_MANAGER_HPP 1
...
class S1GraphManager : public paradevs::pdevs::GraphManager < common::DoubleTime >
{
public:
...
private:
    paradevs::pdevs::Coordinator < common::DoubleTime, S1GraphManager > S1;
    paradevs::pdevs::Coordinator < common::DoubleTime, S2GraphManager > S2;
};
